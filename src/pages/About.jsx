function About() {
  return (
    <div className="p-10 prose">
      {/* Заголовки */}
      <h1 className="text-shadow-lg/20">About Our E-commerce Platform</h1>
      <h2>Our Vision</h2>
      ...
      <p>
        ...
        trusted sellers around the world. Whether you are looking for the latest
        gadgets, fashion, or home essentials, we have got you covered.
      </p>
      ...
      {/* Блок цитат */}
      <blockquote>
        E-commerce is not the cherry on the cake, it is the new cake. —
        Jean-Paul Ago
      </blockquote>
